...
contract TestTokenDecimals is Context, IERC20, Ownable {
     ...
     * construction.
     */
    constructor (string memory name, string memory symbol, uint8 dec) public {
        updateNameAndSymbol(name, symbol);
        _setupDecimals(dec);
        setFee(0,1000);
